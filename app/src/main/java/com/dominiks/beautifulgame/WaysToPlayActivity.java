...
public class WaysToPlayActivity extends AppCompatActivity {
    ...
    private void setupList() {
        BeautifulGameListEntry[] waysToPlay = {
                ...
                new BeautifulGameListEntry("Grass Football", "Football is a family of team sports that involve, to varying degrees, kicking a ball to score a goal.", R.drawable.grassfootball, 5f),
